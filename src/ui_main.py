...
"After the execution, the user can see the all results about the mutation process. User can see the faults, metrics, codes' AST diagram, mutation state graphic and rosbag scenarios. If the user wants to take a V&V report, IM-FIT gives one V&V report including all details.", None))
        ...
        ___qlistwidgetitem310 = self.listWidget_23.item(0)
        ___qlistwidgetitem310.setText(QCoreApplication.translate("MainWindow", u"Detected", None));
        ___qlistwidgetitem311 = self.listWidget_23.item(1)
        ___qlistwidgetitem311.setText(QCoreApplication.translate("MainWindow", u"Undetected", None));
        ___qlistwidgetitem312 = self.listWidget_23.item(2)
        ___qlistwidgetitem312.setText(QCoreApplication.translate("MainWindow", u"Covered", None));
        ___qlistwidgetitem313 = self.listWidget_23.item(3)
        ___qlistwidgetitem313.setText(QCoreApplication.translate("MainWindow", u"Valid", None));
        ___qlistwidgetitem314 = self.listWidget_23.item(4)
        ___qlistwidgetitem314.setText(QCoreApplication.translate("MainWindow", u"Killed", None));
        ___qlistwidgetitem315 = self.listWidget_23.item(5)
        ___qlistwidgetitem315.setText(QCoreApplication.translate("MainWindow", u"Survived", None));
        ___qlistwidgetitem316 = self.listWidget_23.item(6)
        ___qlistwidgetitem316.setText(QCoreApplication.translate("MainWindow", u"No Coverage", None));
        ___qlistwidgetitem317 = self.listWidget_23.item(7)
        ___qlistwidgetitem317.setText(QCoreApplication.translate("MainWindow", u"Timeout", None));
        ___qlistwidgetitem318 = self.listWidget_23.item(8)
        ___qlistwidgetitem318.setText(QCoreApplication.translate("MainWindow", u"Runtime Error", None));
        ___qlistwidgetitem319 = self.listWidget_23.item(9)
        ___qlistwidgetitem319.setText(QCoreApplication.translate("MainWindow", u"Compile Error", None));
        ___qlistwidgetitem320 = self.listWidget_23.item(10)
        ___qlistwidgetitem320.setText(QCoreApplication.translate("MainWindow", u"Ignored", None));
